...
export function ShareButtons({ title }: ShareButtonsProps) {
  ...
  const btnClass =
    'inline-flex items-center gap-1.5 px-3 py-1.5 rounded-full text-sm border border-border bg-card hover:bg-accent transition-colors';

  return (
    <div className="flex flex-wrap items-center gap-2 py-6 border-t border-border/50">
