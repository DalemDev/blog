...
export const metadata: Metadata = {
  title: 'Capa Cero — Ingeniería desde la base',
    ...
    <div className="space-y-8">
      ...
      <section className="text-center py-12 space-y-4">
        <h1 className="text-4xl md:text-5xl font-bold tracking-tight">
          Ingeniería desde la base
        </h1>
        <p className="text-muted-foreground text-lg max-w-xl mx-auto">
          Artículos sobre ingeniería, ciencia de datos e inteligencia artificial para estudiantes, desarrolladores y profesionales.
        </p>
      </section>
      ...
      {/* Pagination */}
      <Pagination page={page} totalPages={result.totalPages} basePath="/" extraParams={extraParams} />
    </div>
  )
}
